...
export function Hero() {
  return (
    <section
      className="relative pt-20 pb-24 md:pt-32 md:pb-32 overflow-hidden bg-paper"
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="order-2 lg:order-1 max-w-2xl">
            ...
            <FadeIn delay={0.2}>
              <h1
                className="text-4xl md:text-5xl lg:text-6xl font-serif text-emerald-900 leading-[1.1] mb-6"
