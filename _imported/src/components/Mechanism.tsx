...
export function Mechanism() {
  return (
    <section className="py-24 bg-emerald-900 text-ivory relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <FadeIn delay={0.2}>
          <p className="text-xl font-serif italic text-ivory/90 mb-8 max-w-2xl mx-auto">
            This isn't just a language guide; it's a cultural DNA transplant.
          </p>
        </FadeIn>

        <FadeIn delay={0.3}>
          <p className="text-lg text-ivory/80 font-sans font-light leading-relaxed max-w-3xl mx-auto">
            Built on the "Respect-First" linguistic framework, this protocol
            focuses on the{' '}
            <strong className="text-gold font-normal">
              "Trinity of Connection": Tone, Timing, and Title.
            </strong>{' '}
            It teaches you how to speak from your chest, catch a waiter's eye
            without being rude, and use specific "honorific" anchors that signal
